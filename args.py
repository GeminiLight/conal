...
from virne.utils import read_setting, write_setting
...
data_arg.add_argument('--p_net_num_nodes', type=int, default=0, help='Number of nodes in the physical network')
...
data_arg.add_argument('--v_sim_setting_node_resource_attrs_high', type=int, default=50, help='')
data_arg.add_argument('--v_sim_setting_link_resource_attrs_low', type=int, default=0, help='')
data_arg.add_argument('--v_sim_setting_link_resource_attrs_high', type=int, default=50, help='')
...
data_arg.add_argument('--if_dynamic_v_nets', type=str2bool, default=False, help='Whether to generate dynamic virtual networks')
...
train_arg.add_argument('--num_meta_learning_epochs', type=int, default=50, help='Number of meta learning epochs')
train_arg.add_argument('--infer_with_single_task_policy_id', type=int, default=0, help='Whether to use single task policy to infer')
train_arg.add_argument('--use_bidirectional_action', type=str2bool, default=True, help='Whether to use bidirectional action')
train_arg.add_argument('--use_meta_learning', type=str2bool, default=True, help='Whether to use meta learning')
train_arg.add_argument('--use_entropy_driven_adaptive_lr', type=str2bool, default=False, help='Whether to use entropy driven adaptive lr')
train_arg.add_argument('--use_curriculum_scheduling_strategy', type=str2bool, default=False, help='Whether to use curriculum scheduling strategy')

train_arg.add_argument('--coef_contrastive_loss', type=float, default=0., help='Coefficient of contrastive loss')
...
run_arg.add_argument('--save_interval', type=int, default=5, help='')

### Safety ###
safety_arg = parser.add_argument_group('safety')
safety_arg.add_argument('--use_baseline_solver', type=str2bool, default=False, help='')
safety_arg.add_argument('--srl_cost_budget', type=float, default=0.05, help='')
safety_arg.add_argument('--srl_alpha', type=float, default=1., help='')
safety_arg.add_argument('--srl_beta', type=float, default=0.1, help='')
safety_arg.add_argument('--srl_lambda', type=float, default=0.1, help='')
