...
pretrained_model_path_dict_for_wx500["a3c_gcn"]="PRETRAINED_MODEL_PATH"
pretrained_model_path_dict_for_wx500["ddpg_attention"]="PRETRAINED_MODEL_PATH"
pretrained_model_path_dict_for_wx500["pg_cnn"]="PRETRAINED_MODEL_PATH"
pretrained_model_path_dict_for_wx500["conal"]="PRETRAINED_MODEL_PATH"


if [ $topology == "wx500" -a $use_pretrained_model == 1 ]; then
    pretrained_model_path=${pretrained_model_path_dict_for_wx500[$pretrained_model_name]}
else
...
do
    ...
    do 
        ...
        python main.py \
            ...
            --lr_actor=0.001 \
            --lr_critic=0.001 \
            --summary_dir="exp_data/conal/wx500" \
            --seed=$seed \
            --summary_file_name="$topology-$solver_name-k_shortest_$k_shortest-aver_arrival_rate_$aver_arrival_rate$identifier.csv"
    done
done