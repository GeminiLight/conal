...
class NodePairStepRLEnv(JointPRStepRLEnv):
    ...
    def __init__(self, p_net, v_net_simulator, controller, recorder, counter, **kwargs):
        super(NodePairStepRLEnv, self).__init__(p_net, v_net_simulator, controller, recorder, counter, **kwargs)
