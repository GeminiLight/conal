...
class ActorCritic(ActorCriticBase):
    ...
    def __init__(self, p_net_num_nodes, p_net_feature_dim, p_net_edge_dim, v_net_feature_dim, v_net_edge_dim, embedding_dim=128, dropout_prob=0., batch_norm=False):
        ...
        self.encoder = StateEncoder(p_net_num_nodes, p_net_feature_dim, p_net_edge_dim, v_net_feature_dim, v_net_edge_dim, embedding_dim, dropout_prob=dropout_prob, batch_norm=batch_norm)
...
class HeteroGnnEncoder(nn.Module):
    ...
    def __init__(self, p_net_num_nodes, p_net_feature_dim, p_net_edge_dim, v_net_feature_dim, v_net_edge_dim, embedding_dim=128, dropout_prob=0., batch_norm=False):
        ...
        self.init_v_lin = nn.Linear(v_net_feature_dim, embedding_dim)
        self.init_p_lin = nn.Linear(p_net_feature_dim, embedding_dim)
...
class StateEncoder(nn.Module):
    ...
    def __init__(self, p_net_num_nodes, p_net_feature_dim, p_net_edge_dim, v_net_feature_dim, v_net_edge_dim, embedding_dim=128, dropout_prob=0., batch_norm=False):
        ...
        self.hetero_gnn_encoder = HeteroGnnEncoder(p_net_num_nodes, p_net_feature_dim, p_net_edge_dim, v_net_feature_dim, v_net_edge_dim, embedding_dim=128, dropout_prob=0., batch_norm=False)
